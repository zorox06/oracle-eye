  ...
  return (
    <div className="grid w-full items-stretch gap-3 sm:w-auto sm:grid-cols-3">
      <div className="sm:aspect-square">
        <Card className="relative h-full overflow-hidden border-border/60 bg-card/50 p-4 backdrop-blur supports-[backdrop-filter]:bg-card/40">
      ...
      <div className="sm:aspect-square">
        <Card className="relative flex h-full flex-col overflow-hidden border-border/60 bg-card/50 p-4 backdrop-blur supports-[backdrop-filter]:bg-card/40">
          <div>
